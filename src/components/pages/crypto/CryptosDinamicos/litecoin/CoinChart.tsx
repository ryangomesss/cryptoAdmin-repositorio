...
export default function CoinChartLTC() {
  ...
  const data = {
    ...
    datasets: [
      {
        label: "Dataset",
        data: [800, 400, 900, 600, 500, 800, 400, 400, 200, 600, 300, 500],
        fill: true,
        borderColor: "#5F5F5F",
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center justify-end gap-4 w-1/3">
          <div className="flex flex-col items-end">
            ...
            <span className="font-bold text-sm text-[#00000021]">LTC</span>
          </div>
          <IconLtc color="#5F5F5F" size={64} />
        </div>
      </div>
