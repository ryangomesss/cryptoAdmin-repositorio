...
export default function CoinChartBTC() {
  ...
  const data = {
    ...
    datasets: [
      {
        label: "Dataset",
        data: [500, 300, 620, 200, 400, 400, 800, 500, 600, 900, 400, 800],
        fill: true,
        borderColor: "#FFAB2D",
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center justify-end gap-4 w-1/3">
          <div className="flex flex-col items-end">
            ...
            <span className="font-bold text-sm text-[#00000021]">BTC</span>
          </div>
          <IconBtc color="#FFAB2D" size={64} />
        </div>
      </div>
